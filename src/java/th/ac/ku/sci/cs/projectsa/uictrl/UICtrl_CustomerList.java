...
public class UICtrl_CustomerList {
    @FXML
    private ListView<ListViewRowDataWrapper<String>> custListView;
    @FXML
    private TextField textField_SearchBox;
    ...
    @FXML
    private void onBack_Button() throws java.sql.SQLException, java.security.NoSuchAlgorithmException, Throwable {
        try {
    ...
    @FXML
    private void creatNewCustomer_Button() throws java.io.IOException {
        try {
    ...
    @FXML
    private void searchCustomer_Button() throws java.sql.SQLException {
        try {
