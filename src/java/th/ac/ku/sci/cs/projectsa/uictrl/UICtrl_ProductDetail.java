...
public class UICtrl_ProductDetail {
    ...
    @FXML
    private TextField textField_PdID, textField_SrID;
    @FXML
    private TextField textField_Brand, textField_Model;
    @FXML
    private TextField textField_PdStatus, textField_PdPrice, textField_PdArriveDate;
    @FXML
    private Button button_MainAction;
    ...
    @FXML
    private void onMainAction_Button() throws java.io.IOException, java.sql.SQLException {
        try {
            int tmpt_int = 0;
