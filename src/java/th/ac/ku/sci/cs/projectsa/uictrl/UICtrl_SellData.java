...
public class UICtrl_SellData {
    ...
    @FXML private TextField textField_Date;
    ...
    @FXML private TextField textField_TPrice;
    ...
    @FXML private void initialize() throws Throwable {
        try {
            ...
            // 5 PD.Product_Status
            DatabaseMnm.DataSpec.STATUS_Product tmpk_Product_Status=DatabaseMnm.DataSpec.STATUS_Product.values()[
